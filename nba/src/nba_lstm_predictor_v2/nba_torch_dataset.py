...
class NbaDatasetV2(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            player_ids (np.ndarray): Player IDs.
        """
        ...
        self.player_ids = self.process_sequence_to_torch(
            player_ids, torch.long, np.int64
        )
...
# Example usage
# dataset = NbaDataset(X_data, Y_data, player_ids)
