...
from ..models.nba_lstm_branched import PlayerEmbeddingLSTM
...
class NbaLstmPredictorModel(PipelineComponent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model = PlayerEmbeddingLSTM(**model_config)
    ...
    def _load_model_from_s3(self, model_path: str) -> None:
        ...
        state_dict = torch.load(
            io.BytesIO(obj["Body"].read()), map_location=self.device
        )
    ...
    def _train(self, data: Any, state: Any, **kwargs) -> PlayerEmbeddingLSTM:
        """
